const messages = {
    zh: {
        ...
        'hero.beta': '加入种子用户',
        'hero.support': '支持 Zotero 7、8、9 和 10',
        ...
        'closing.meta': '需要 MinerU API Token · 支持 Zotero 7–10 · MIT License',
    ...
    en: {
        ...
        'hero.support': 'Supports Zotero 7, 8, 9, and 10',
        ...
        'closing.meta': 'MinerU API Token required · Zotero 7–10 · MIT License',
